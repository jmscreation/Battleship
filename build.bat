...
set LIBRARY_DIRECTORIES=libraries\libfreedialog-main srclibs\game srclibs\sfml
set LIBRARY_NAMES=freedialog sfml-network-s sfml-system-s winmm ws2_32 pthread setupapi user32 gdi32 opengl32 gdiplus Shlwapi dwmapi stdc++fs comdlg32
